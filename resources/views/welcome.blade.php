...
<head>
    ...
    <!-- TITLE -->
    <title>Eduker - School System</title>
...
<body class="app sidebar-mini ltr landing-page horizontal">
            ...
            <div class="page">
                        ...
                        <div class="container-fluid main-container">
                            <div class="d-flex">
                                ...
                                <a class="logo-horizontal " href="index.html">
                                    <img src="{{URL::asset('assets/images/brand/logo-new.png')}}" class="header-brand-img desktop-logo"
                                        alt="logo">
                                    <img src="{{URL::asset('assets/images/brand/logo-new.png')}}" class="header-brand-img light-logo1"
                                        alt="logo">
                                </a>
                                <!-- LOGO -->
                                        ...
                                        <div class="collapse navbar-collapse bg-white px-0" id="navbarSupportedContent-4">
                                            ...
                                            <div class="header-nav-right p-5">
                                                <a href="register.html"
                                                    class="btn ripple btn-min w-sm btn-outline-primary me-2"
                                    ...
                                    <div class="row">
                                        <div class="main-sidemenu navbar px-0">
                                            <a class="navbar-brand ps-0 d-none d-lg-block" href="index.html">
                                                <img alt="" class="logo-2" src="{{URL::asset('assets/images/brand/logo-new.png')}}">
                                            </a>
                                                ...
                                                @if (Route::has('login'))
                                                    @auth
                                                        <a href="{{ url('/dashboard') }}"
                                                            class="btn ripple btn-min w-sm btn-primary me-2">Dashboard</a>
                                                    @else
                                                        <a href="{{ route('login') }}"
                                                        ...
                                                        @if (Route::has('register'))
                                                            <a href="{{ route('register') }}"
                                                                class="btn ripple btn-min w-sm btn-outline-primary me-2">New
                                                                User
                                                            </a>
                                                        @endif
                                                    @endif
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 mb-5 pb-5 animation-zidex pos-relative">
                                            ...
                                            <h6 class="pb-3">
                                                ...
                                                you need to start from scratch with HTML, SCSS, CSS, and JS and with lots of
                                                coding,
                                        ...
                                        <div class="col-xl-6 col-lg-6 my-auto">
                                            <img src="{{URL::asset('assets/images/landing/market4.png')}}" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                            ...
                                                            <div class="card-body bg-secondary-transparent">
                                                                <div class="counter-status">
                                                                    ...
                                                                    <div class="text-body text-center">
                                                                        ...
                                                                        <div class="counter-text">
                                                                            <h5 class="font-weight-normal mb-0 ">Integrated
                                                                                Plugins</h5>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="card-body bg-success-transparent">
                                                                <div class="counter-status">
                                                                    ...
                                                                    <div class="text-body text-center">
                                                                        ...
                                                                        <div class="counter-text">
                                                                            <h5 class="font-weight-normal mb-0 ">Form Elements
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="card-body bg-danger-transparent">
                                                                <div class="counter-status">
                                                                    ...
                                                                    <div class="text-body text-center">
                                                                        ...
                                                                        <div class="counter-text">
                                                                            <h5 class="font-weight-normal mb-0 ">Customize
                                                                                Widgets</h5>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <p class="text-default mb-5 text-center">The Sash admin template comes with
                                                        ready-to-use features that are completely easy-to-use for any user, even
                                                        for a beginner.</p>
                                                    <div class="row mt-7">
                                                        <div class="col-lg-6 col-md-12">
                                                            <div class="card features main-features main-features-1 wow fadeInUp reveal revealleft"
                                                                ...
                                                                <div class="text-left">
                                                                    ...
                                                                    <p class="mb-0">The Sash admin code is maintained
                                                                        very cleanly and well-structured with proper comments.
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-md-12">
                                                            <div class="card  features main-features main-features-2 wow fadeInUp reveal revealleft"
                                                                ...
                                                                <div class="text-left">
                                                                    ...
                                                                    <p class="mb-0">
                                                                        We included multiple demos, preview video, and screen
                                                                        shots to give a quick overview of our Sash admin
                                                                        template.
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6 col-md-12">
                                                            <div class="card features main-features main-features-11 wow fadeInUp reveal revealleft"
                                                                ...
                                                                <div class="text-left">
                                                                    ...
                                                                    <p class="mb-0">
                                                                        Different types of “Form Validation” are implemented in
                                                                        this Sash admin template and used strict validation
                                                                        rules.
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6 col-md-12">
                                                            <div class="card features main-features main-features-10 wow fadeInUp reveal revealleft"
                                                                ...
                                                                <div class="text-left">
                                                                    ...
                                                                    <p class="mb-0">
                                                                        30+ widgets are included in this template. Please check
                                                                        out the best option that suits you and implement it in
                                                                        your projects.
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="card features main-features main-features-12 mb-4 wow fadeInUp reveal revealleft"
                                                                ...
                                                                <div class="text-left">
                                                                    ...
                                                                    <p class="mb-0">
                                                                        ...
                                                                        Sash admin template. The documentation is explained or
                                                                        instructed in such a way that every user can understand.
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="text-center">
                                                        <h2 class="text-center fw-semibold">Our mission is to make work
                                                            meaningful.</h2>
                                                    </div>
                                                    <div class="col-lg-12">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-xl-6 col-lg-6 ps-0">
                                                                            <div class="text-center reveal revealleft mb-3">
                                                                                <img src="{{URL::asset('assets/images/landing/business-team-working-on-business-plan.png')}}"
                                                                                    alt="" class="br-5">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-xl-6 col-lg-6 pe-0 my-auto">
                                                                            ...
                                                                            <div class="ps-5 reveal revealright">
                                                                                <h2 class="text-start fw-semibold fs-25 mb-6">
                                                                                    We are a creative agency with a passion for
                                                                                    design.</h2>
                                                                                <div class="d-flex">
                                                                                    ...
                                                                                    <div class="ms-5 mb-4">
                                                                                        <h5 class="fw-bold">Quality &
                                                                                            Clean Code</h5>
                                                                                        <p>The Sash admin code is maintained
                                                                                            very cleanly and well-structured
                                                                                            with proper comments.</p>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="d-flex">
                                                                                    <span><svg style="width:20px;height:20px"
                                                        ...
                                                        <div class="demo-screen-skin code-quality" id="dependencies">
                                                            <div class="text-center p-0">
                                                                <h2 class="text-center fw-semibold text-white">Features Used in
                                                                    Sash Admin Template</h2>
                                                                <div class="row justify-content-center">
                                                                    <div class="col-lg-12 px-0">
                                                                        <div class="feature-logos mt-5">
                                                                            <div class="slide">
                                                                                <img src="{{URL::asset('assets/images/landing/web/1.png')}}">
                                                                                <h5 class="mt-3 text-white">Bootstrap5</h5>
                                                                            </div>
                                                                            <div class="slide">
                                                                                <img src="{{URL::asset('assets/images/landing/web/2.png')}}">
                                                                                <h5 class="mt-3 text-white">HTML5</h5>
                                                                            </div>
                                                                            <div class="slide">
                                                                                <img src="{{URL::asset('assets/images/landing/web/3.png')}}">
                                                                                <h5 class="mt-3 text-white">JQuery</h5>
                                                                            </div>
                                                                            <div class="slide">
                                                                                <img src="{{URL::asset('assets/images/landing/web/4.png')}}">
                                                                                <h5 class="mt-3 text-white">Sass</h5>
                                                                            </div>
                                                                            <div class="slide">
                                                                                <img src="{{URL::asset('assets/images/landing/web/5.png')}}">
                                                                                <h5 class="mt-3 text-white">Gulp</h5>
                                                                            </div>
                                                                            <div class="slide">
                                                                                <img src="{{URL::asset('assets/images/landing/web/6.png')}}">
                                                                                    ...
                                                                                    <div class="card-header grid-link"
                                                                                        ...
                                                                                        <a href="#"
                                                                                            class="card-options-collapse  h5 fw-bold card-title mb-0 text-info"><span
                                                                                                class="badge"><i
                                                                                                    class="fe fe-chevron-up fs-15 me-3"></i></span>Switch
                                                                                            Easily From One Color to Another
                                                                                            Color style</a>
                                                                                    </div>
                                                                                    <div class="card-body pt-0">
                                                                                        <p class="mb-3">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="card-body pt-0">
                                                                                        <p>
                                                                                            ...
                                                                                            Styles.
                                                                                            Where the users can change their
                                                                                            Side Menu styles by using single
                                                                                            assets.
                                                                                        </p>
                                                                                        <p class="mt-2 mb-3">
                                                                                            <span class="fw-bold">Note:
                                        ...
                                        <div class="bg-landing section bg-image-style">
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <span class="landing-title"></span>
                                                    <h2 class="text-center fw-semibold">Find the <span
                                                            class="text-primary">Perfect Plan</span> for your Business.</h2>
                                                                        ...
                                                                        <div class="card p-3 pricing-card reveal revealrotate">
                                                                            <div
                                                                                ...
                                                                                <p class="text-justify fw-semibold mb-1"> <span
                                                                                        ...
                                                                                        year</span></p>
                                                                                <p class="fs-13 mb-1">Lorem ipsum dolor sit
                                                                                    amet consectetur adipisicing elit. Iure quos
                                                                                    debitis aliquam .</p>
                                                                                <p class="fs-13 mb-1 text-secondary">Billed
                                                                                    monthly on regular basis!</p>
                                                                            </div>
                                                                            <div class="card-body pt-2">
                                                                                <ul class="text-justify pricing-body ps-0">
                                                                                    ...
                                                                                    <li class="text-muted"><i
                                                                                            class="mdi mdi-close-circle-outline p-2 fs-16 text-gray"></i><strong>
                                                                                            Unlimited </strong> Cloud Storage
                                                                                    </li>
                                                                                    <li class="text-muted"><i
                                                                                            class="mdi mdi-close-circle-outline p-2 fs-16 text-gray"></i><strong>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <p class="text-justify fw-semibold mb-1"> <span
                                                                                        ...
                                                                                        class="fs-25"><span
                                                                                            class="op-0-5 text-muted text-20">/</span>
                                                                                        year</span></p>
                                                                                <p class="fs-13 mb-2">Lorem ipsum dolor sit
                                                                                    amet consectetur adipisicing elit. Iure quos
                                                                                    debitis aliquam .</p>
                                                                                <p class="fs-13 mb-1 text-primary">Billed
                                                                                    monthly on regular basis!</p>
                                                                            </div>
                                                                            <div class="card-body pt-2">
                                                                                <ul class="text-justify pricing-body ps-0">
                                                                        ...
                                                                        <div class="card p-3 pricing-card reveal revealrotate">
                                                                            <div
                                                                                ...
                                                                                <p class="fs-13 mb-1">Lorem ipsum dolor sit
                                                                                    amet consectetur adipisicing elit. Iure quos
                                                                                    debitis aliquam .</p>
                                                                                <p class="fs-13 mb-1  text-danger">Billed
                                                                                    monthly on regular basis!</p>
                                                                            </div>
                                                                            <div class="card-body pt-2">
                                                                                <ul class="text-justify pricing-body ps-0">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="row justify-content-center">
                                                        <p class="col-xl-9 wow fadeInUp text-default sub-text mb-7"
                                                            ...
                                                            It is also a premium admin dashboard with high-end features, where
                                                    ...
                                                    <section class="sptb demo-screen-demo" id="faqs">
                                                        <div class="row align-items-center">
                                                                ...
                                                                <div class="col-md-12 grid-item  px-0">
                                                                    <div
                                                                        ...
                                                                        <div class="card-body pt-0">
                                                                            ...
                                                                            <p class="mt-2 mb-3">
                                                                                <span class="fw-bold">Note:
                                                                                </span>Please Refer support section for more
                                                                                information.
                                                                            </p>
                                                                            <a href="#" target="_blank"
                                                                                class="btn btn-outline-primary tx-13">Click
                                                            ...
                                                            <div class="col-md-12 col-lg-6 reveal revealright">
                                                                <img src="{{URL::asset('assets/images/landing/frequently-asked-questions.png')}}"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    </section>
                                                            ...
                                                            <div class="card-body px-1">
                                                                <div class="d-flex overflow-visible">
                                                                    <a href="blog-details.html"
                                                                        ...
                                                                        data-bs-image-src="{{URL::asset('assets/images/media/12.jpg')}}"
                                                                        style="background: url(&quot;{{URL::asset('assets/images/media/12.jpg')}}&quot;) center center;"></a>
                                                                    <div class="ps-3 flex-column">
                                                                        ...
                                                                        <div class="">Excepteur sint occaecat
                                                                            cupidatat non proident, accusantium sunt in culpa
                                                        ...
                                                        <div class="card bg-transparent reveal">
                                                            <div class="card-body px-1">
                                                                <div class="d-flex overflow-visible">
                                                                    <a href="blog-details.html"
                                                                        class="card-aside-column br-5 cover-image"
                                                                        data-bs-image-src="{{URL::asset('assets/images/media/22.jpg')}}"
                                                                        style="background: url(&quot;{{URL::asset('assets/images/media/22.jpg')}}&quot;) center center;"></a>
                                                                    <div class="ps-3 flex-column">
                                                                        <span
                                                        ...
                                                        <div class="card bg-transparent reveal">
                                                            <div class="card-body px-1">
                                                                <div class="d-flex overflow-visible">
                                                                    <a href="blog-details.html"
                                                                        class="card-aside-column br-5 cover-image"
                                                                        data-bs-image-src="{{URL::asset('assets/images/media/about.jpg')}}"
                                                                        style="background: url(&quot;{{URL::asset('assets/images/media/about.jpg')}}&quot;) center center;"></a>
                                                                    <div class="ps-3 flex-column">
                                                                        <span
                                                        ...
                                                        <div class="card bg-transparent reveal">
                                                            <div class="card-body px-1">
                                                                <div class="d-flex overflow-visible">
                                                                    <a href="blog-details.html"
                                                                        class="card-aside-column br-5 cover-image"
                                                                        data-bs-image-src="{{URL::asset('assets/images/media/25.jpg')}}"
                                                                        style="background: url(&quot;{{URL::asset('assets/images/media/25.jpg')}}&quot;) center center;"></a>
                                                                    <div class="ps-3 flex-column">
                                                                        <span
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="card bg-transparent">
                                                            <div class="card-body pt-5">
                                                                <h4 class="text-center fw-semibold text-white-80">Testimonials
                                                                </h4>
                                                                <span class="landing-title"></span>
                                                                <h2 class="text-center fw-semibold text-white mb-7">What People
                                                                    Are Saying About Our Product.</h2>
                                                                            ...
                                                                            <div class="col-xl-8 col-md-12 d-block mx-auto">
                                                                                <div class="testimonia">
                                                                                    <p class="text-white-80">
                                                                                        ...
                                                                                        id officiis hic tenetur quae quaerat
                                                                            ...
                                                                            <div class="text-dark">
                                                                                <div class="services-statistics reveal my-5">
                                                                                    <div class="row text-center">
                                                                                        <div
                                                                                            class="col-xl-3 col-md-6 col-lg-6">
                                                                                            <div class="card">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="card bg-transparent">
                                                                <div class="card-body pt-5 px-7">
                                                                    <div class="row">
                                                                        <div class="col-lg-9">
                                                                            <h1 class="fw-semibold text-white">Start Your
                                                                                Project with Sash.</h1>
                                                                            <p class="text-white">Sed ut perspiciatis unde
                                                                        ...
                                                                        <div class="col-lg-3 text-end my-auto">
                                                                            <a href="https://themeforest.net/item/sash-bootstrap-5-admin-dashboard-template/35183671"
                                                                                ...
                                                                                class="btn btn-pink w-lg pt-2 pb-2"><i
                                                                                    class="fe fe-shopping-cart me-2"></i>Buy
                                                                                Now
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <div class="top-footer">
                                            <div class="row">
                                                <div class="col-lg-4 col-sm-12 col-md-12 reveal revealleft">
                                                    ...
                                                    <p class="mb-5 mb-lg-2">Duis aute irure dolor in reprehenderit in
                                                ...
                                                <div class="col-lg-4 col-sm-12 col-md-4 reveal revealleft">
                                                    <div class="">
                                                        <a href="index.html"><img loading="lazy" alt="" class="logo mb-3"
                                                                src="{{URL::asset('assets/images/brand/logo-3.png')}}"></a>
                ...
                <script src="{{URL::asset('assets/plugins/company-slider/slider.js')}}"></script>
